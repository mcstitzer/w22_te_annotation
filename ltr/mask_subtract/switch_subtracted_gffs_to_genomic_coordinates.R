...
masked=paste(OUTDIR, '/mask_subtract/subtract', 1:maxSubtract, '_', GENOMENAME, '/', GENOMENAME, '.subtract', 1:maxSubtract, '.ltrharvest.contignames.tsd.ltrretrotransposon.gff3', sep='')
filenames=c(paste(OUTDIR, '/mask_subtract/', GENOMENAME, '.ltrharvest.contignames.tsd.ltrretrotransposon.gff3', sep=''), masked)
...
#                gff=import.gff(filenames[x])  ### import a gff
...
saveRDS(gl, paste(OUTDIR, '/mask_subtract/', GENOMENAME, '_gl_', maxSubtract, '.RDS', sep=''))
...
gffmasked=paste(OUTDIR, '/mask_subtract/subtract', 1:maxSubtract, '_', GENOMENAME, '/', GENOMENAME, '.subtract', 1:maxSubtract, '.ltrharvest.contignames.gff3', sep='')
gfffilenames=c(paste(OUTDIR, '/mask_subtract/', GENOMENAME, '.ltrharvest.contignames.gff3', sep=''), gffmasked)
