#!/bin/bash
#SBATCH -D /group/jrigrp8/mstitzer/multiple_maize_assemblies/w22/line
#SBATCH -o /group/jrigrp8/mstitzer/multiple_maize_assemblies/slurm-log/target_line-stdout-%j.txt
#SBATCH -e /group/jrigrp8/mstitzer/multiple_maize_assemblies/slurm-log/target_line-stderr-%j.txt
#SBATCH -J target_dna
#SBATCH -p serial
